...
def RecupListe():
    """recupere les fichiers de devoirs dans le repertoire courant et renvois
    une liste"""
...
def CreMenuDM_prof(listeDM,listeDMC,listeDMB):
    return
...
def CreMenuDS_prof(listeDS,listeDSC,listeDSB):
    return
...
creer_page(code_entete,CreMenuDM_Mobile_eleve(),code_sep_mobile,CreMenuDS_Mobile_eleve(),
           code_sep_mob_pc,CreMenuDM_PC_eleve(),code_sep_pc,CreMenuDS_PC_eleve(),code_fin)
